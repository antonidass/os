...
struct sembuf PRODUCE_LOCK[2] = {{ BIN_SEM, -1, 0 }, { BUF_EMPTY, -1, 0 }  };
struct sembuf PRODUCE_RELEASE[2] = {{ BIN_SEM, 1, 0 }, { BUF_FULL, 1, 0 },  };

struct sembuf CONSUME_LOCK[2] = {{ BIN_SEM, -1, 0 }, { BUF_FULL, -1, 0 },  };
struct sembuf CONSUME_RELEASE[2] = {{ BIN_SEM, 1, 0 }, { BUF_EMPTY, 1, 0 },  };
